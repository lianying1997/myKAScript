...
{
    [ScriptType(name: "M4s绘图+", territorys:[1232],guid: "90e34cd9-0793-43f3-9daf-df63d2612e82", version:"0.0.0.8.alpha", author: "Usami From Karlin")]
    public class M4s绘图绘图
    {
        ...
        Vector4 color_Red = new Vector4(1f, 0f, 0f, 1f);
        Vector4 color_Green = new Vector4(0f, 1f, 0f, 1f);
        Vector4 color_Cyan = new Vector4(0.2f, 1f, 1f, 1f);
        ...
        public void 雷电buff分散站位(Event @event, ScriptAccessory accessory)
        {
            ...
            dp1.Name = "跳跃引导-1";
            dp1.Scale = new(6);
            dp1.Color = imP1lighting? color_Red: color_Green;
            dp1.Position = new(100, 0, 100);
            dp1.CentreResolvePattern = Hitnear? PositionResolvePatternEnum.PlayerNearestOrder : PositionResolvePatternEnum.PlayerFarestOrder;
            dp1.CentreOrderIndex = 1u;
            dp1.DestoryAt = 6000;
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp1);

            dp1.Name = "跳跃引导-2";
            dp1.CentreOrderIndex = 2u;
            dp1.DestoryAt = 6000;
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp1);

            dp1.Name = "跳跃引导-3";
            dp1.CentreOrderIndex = 3u;
            dp1.DestoryAt = 6000;
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp1);

            dp1.Name = "跳跃引导-4";
            dp1.CentreOrderIndex = 4u;
            dp1.DestoryAt = 6000;
            accessory.Method.SendDraw(DrawModeEnum.Default, DrawTypeEnum.Circle, dp1);
        ...
        public void 激光buff处理位置(Event @event, ScriptAccessory accessory)
        {
            ...
            if (statusID == "4004" || statusID == "4005")
            {
                ...
                if (LaserPosition==LaserPositionEnum.Game8_TN外D内)
                {
                    var dvx = isEastYellowLaser ? 1 : -1;
                    dealPos += myIndex > 3 ? new(-2.9f * dvx, 0, 0) : new(2.9f * dvx, 0, 0);
                }
                if (LaserPosition==LaserPositionEnum.MMW_TN左D右)
                {
